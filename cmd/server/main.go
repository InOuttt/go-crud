...
import (
	...
	_ "github.com/lib/pq"
	"github.com/inouttt/go-crud/internal/profile"
	"github.com/inouttt/go-crud/internal/user"
	"github.com/inouttt/go-crud/internal/auth"
	"github.com/inouttt/go-crud/internal/config"
	"github.com/inouttt/go-crud/internal/errors"
	"github.com/inouttt/go-crud/internal/healthcheck"
	"github.com/inouttt/go-crud/pkg/accesslog"
...
func buildHandler(logger log.Logger, db *dbcontext.DB, cfg *config.Config) http.Handler {
	...
	profile.RegisterHandlers(rg.Group(""),
		profile.NewService(profile.NewRepository(db, logger), logger, user.NewRepository(db, logger)),
		authHandler, logger,
	)
